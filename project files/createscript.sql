...
CREATE SCHEMA IF NOT EXISTS `rpgame` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci ;
USE `rpgame` ;

-- -----------------------------------------------------
-- Table `rpgame`.`account`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `rpgame`.`account` (
...
-- -----------------------------------------------------
-- Table `rpgame`.`character`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `rpgame`.`character` (
  ...
  CONSTRAINT `fk_character_account1`
    ...
    REFERENCES `rpgame`.`account` (`account_ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `rpgame`.`abilitiy`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `rpgame`.`abilitiy` (
...
-- Table `rpgame`.`items`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `rpgame`.`items` (
  ...
  CONSTRAINT `fk_items_abilitiy1`
    ...
    REFERENCES `rpgame`.`abilitiy` (`ability_ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `rpgame`.`skill`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `rpgame`.`skill` (
...
-- -----------------------------------------------------
-- Table `rpgame`.`character_has_skill`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `rpgame`.`character_has_skill` (
  ...
  CONSTRAINT `fk_character_has_skill_character1`
    ...
    REFERENCES `rpgame`.`character` (`character_ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_character_has_skill_skill1`
    FOREIGN KEY (`skill_skill_ID` )
    REFERENCES `rpgame`.`skill` (`skill_ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `rpgame`.`character_has_items`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `rpgame`.`character_has_items` (
  `character_character_ID` INT NOT NULL ,
  ...
  CONSTRAINT `fk_character_has_items_items1`
    ...
    REFERENCES `rpgame`.`items` (`item_ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
